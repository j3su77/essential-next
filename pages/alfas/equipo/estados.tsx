...
const EstadosPage: FC<Props> = ({ num, data }) => {
  ...
  useEffect(() => {
    ...
    setUnoData(
      data
        .filter((criterio: any) => criterio.id_estado == 24)
    ...
    setDosData(
      data
        .filter((criterio: any) => criterio.id_estado == 25)
        .sort(function (a: any, b: any) {
          return a.id - b.id;
        })
    );
    ...
    setTresData(
      data
        .filter((criterio: any) => criterio.id_estado == 26)
        .sort(function (a: any, b: any) {
          return a.id - b.id;
        })
    );
    ...
    setCuatroData(
      data
        .filter((criterio: any) => criterio.id_estado == 27)
        .sort(function (a: any, b: any) {
          return a.id - b.id;
        })
    );
    ...
    <MainLayout title="estados">
      {isLoading ? (
        ...
        <div style={{ margin: "auto" }}>
          <ButtonBack text="atras" link="/alfas/equipo" />
