...
export const AlfaBar: FC<Props> = ({ alfa, tipo, percent }) => {
  ...
  return (
    <Link href={`${asPath}/${alfa.toLowerCase().replaceAll(" ", "-")}`}>
      <a
        style={{ width: "480px", minWidth: "380px", maxWidth: "500px" }}
        className={`${styles.baralpha__container} ${tipo}__light ${tipo}__text-dark`}
      >
        ...
        <div className={styles.baralpha__percent}>
          ...
          <span
            className={`${styles.baralpha__progress} ${tipo}__dark`}
            style={{ width: percent + "%" }}
          ></span>
        </div>
      </a>
